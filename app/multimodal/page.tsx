    ...
    <Card className="flex h-full flex-col">
      ...
      <CardContent className="flex flex-1 flex-col gap-3">
        <div
          ...
          className="flex cursor-pointer flex-col items-center gap-2 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 py-5 transition-colors hover:border-[#F5CA50]/50 hover:bg-[#FFFAEC]"
        >
          {preview ? (
            <img src={preview} alt="Selected preview" className="max-h-24 rounded-lg object-contain" />
          ) : (
